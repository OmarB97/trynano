# Steps for Non-Coders:
 ...
 - Step 3: Translate each sentence in the file. Only modify the sentences, do not touch any words to the left of the ':' or any curly braces (e.g. {faucetBalance} ) or the translation might not work properly!
